### R script to run the GenomicSEM for Multivariate GWAS in Lisa
### Infos on the method https://github.com/MichelNivard/GenomicSEM/wiki/4.-Common-Factor-GWA
### Compare to previous version, Genomic SEM has change how the output og userGWAS, and this one has 2 more columns.. and addSNPS has an extra arg (parallel=F)
...
# Get two datasets with the loadings for to the cognitive latente variable and the noncognitive latente variable
