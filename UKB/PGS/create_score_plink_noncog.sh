...
cp  /home/pdemange/GeneticNurtureNonCog/LDpred_weights/NonCog/* .
...
module load pre2019
module load plink2
plink --bfile $ValGf --score $TMPDIR/NONCOG_CEU_WTS_LDpred-inf.txt 3 4 7 --out $TMPDIR/scores/NONCOG_LDpred-inf_scores 


cp -r $TMPDIR/scores /home/pdemange/UKB/PGS/NonCog
