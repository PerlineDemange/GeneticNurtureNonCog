...
method <- read_csv("../Meta-analysis/meta_method_200730.csv")
...
adoption<- as.data.frame(cbind(c(replicate(2, "NonCog"),replicate(2, "Cog")),
                                  ...
                                  rep(c('adopt'), 4),
                               c(0.187592,0.021331,0.182143,0.078868),#noncog direct indirect, cog same
                               c(0.012349,0.017275,0.012239,0.016843),
                               NA,NA,NA,NA))
